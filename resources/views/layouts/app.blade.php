...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen  sm:items-center py-4 sm:pt-0">
            ...
            @endif
            <section class="hero-section" style="background-image: url('path_to_your_background_image.jpg'); background-size: cover;">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-5">
                    <div class="mt-md-4">
                        <div>
                            <span class="badge bg-success font-13 rounded-pill">Welcome</span>
                            <span class="text-white-50 ms-1">Welcome to our Agriculture Project</span>
                        </div>
                        <h2 class="text-white fw-normal mb-4 mt-3 lh-base">
                            Empowering Agriculture with AI
                        </h2>

                        <p class="mb-4 font-16 text-white-50">Explore our innovative solutions to improve crop yield, manage farms, and revolutionize agriculture using AI technology.</p>

                        <a href="#" class="btn btn-primary">Learn More <i class="mdi mdi-arrow-right ms-1"></i></a>
                    </div>
                </div>
            </div>
        </div>
